<?php /* Smarty version 2.6.11, created on 2009-06-08 21:18:45
	        	...
	        	if(typeof result != \'undefined\') {
		        	...
		        	_pmg.clearGrid();
		   			for (var x = 0; x < result[\'packages\'].length; x++){
                        ...
                        row[1] = result[\'packages\'][x][\'file_install\'];
                        row[2] = result[\'packages\'][x][\'file\'];
...
PackageManagerGrid = function(){
	...
	';  if ($this->_tpl_vars['module_load'] == 'true'):  echo '
		_fileGrid = new YAHOO.ext.grid.DDGrid(
                ...
                new YAHOO.ext.grid.DefaultColumnModel([
					{header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Name'];  echo '\', width: 200, sortable: true, sortType: sort.asUCString},
                    {header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Install'];  echo '\', width: 60, renderer: this.renderInstallButton},
                    {header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Delete'];  echo '\', width: 120, renderer: this.renderDeleteButton},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Type'];  echo '\', width: 60},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Version'];  echo '\', width: 50},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Published'];  echo '\', width: 75},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Uninstallable'];  echo '\', width: 70},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Description'];  echo '\', width: 370, sortable: true, sortType: sort.asUCString}
            ...
            _fileGrid.autoSizeColumns = true;
	           ...
	           _fileGridInstalled = new YAHOO.ext.grid.DDGrid(
                ...
                new YAHOO.ext.grid.DefaultDataModel(mti_installed_data),
                 new YAHOO.ext.grid.DefaultColumnModel([
					{header: \'';  echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Name'];  echo '\', width: 200, sortable: true, sortType: sort.asUCString},
                    {header: \'';  echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Install'];  echo '\', width: 5, hidden:true},
                    {header: \'';  echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Action'];  echo '\', width: 80, renderer: this.renderUninstallButton},
                    {header: \'';  echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Enable_Or_Disable'];  echo '\', width: 80, renderer: this.renderEnableDisableButton},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Type'];  echo '\', width: 60},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Version'];  echo '\', width: 50},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Date_Installed'];  echo '\', width: 105},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Uninstallable'];  echo '\', width: 5, hidden:true},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRIDINSTALLED_COLUMN']['Description'];  echo '\', width: 475, sortable: true, sortType: sort.asUCString}
        		])
            );
	...
	';  else:  echo '
  		_fileGrid = new YAHOO.ext.grid.DDGrid(
                ...
                new YAHOO.ext.grid.DefaultColumnModel([
					{header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Description'];  echo '\', width: 215},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Version'];  echo '\', width: 72},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Build'];  echo '\', width: 80, sortable: true, sortType: sort.asUCString},
        		    {header: \'';  echo $this->_tpl_vars['ML_FILEGRID_COLUMN']['Action'];  echo '\', width: 90, renderer: this.renderButtons}
        		])
            );
            _fileGrid.autoSizeColumns = true;
...
var output = "<input type=\'button\' class=\'button\' value=\'';  echo $this->_tpl_vars['MOD']['LBL_UW_BTN_DELETE_PACKAGE'];  echo '\' onClick=\'PackageManager.remove(\\""+file+"\\");\'>";
