...
function changeQS() {
	...
	if(typeof(disabledModules[new_module]) != 'undefined') {
		sqs_objects['{{$vardef.name}}']['disable'] = true;
		document.getElementById('{{$vardef.name}}').readOnly = true;
	}
	else {
		sqs_objects['{{$vardef.name}}']['disable'] = false;
		document.getElementById('{{$vardef.name}}').readOnly = false;
	}	
	
	sqs_objects['{{$vardef.name}}']['modules'] = new Array(new_module);
	enableQS(false);
}
{/literal}
</script>
