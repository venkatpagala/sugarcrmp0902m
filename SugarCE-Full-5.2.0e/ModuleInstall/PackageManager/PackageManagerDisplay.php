...
class PackageManagerDisplay{
   ...
   /**
    ...
    function buildPackageDisplay($form1, $hidden_fields, $form_action, $types = array('module'), $active_form = 'form1', $install = false){
        ...
        $form2 .= "</td><td align='left'><div id='workingStatusDiv' style='display:none;'>".get_image($image_path."sqsWait","border='0' align='bottom'")."</div></td><td align='right'>";
        if($isAlive){
            $form2 .= "<slot><a class=\"listViewTdToolsS1\" id='href_animate' onClick=\"PackageManager.toggleDiv('span_animate_server_div', 'catview');\"><span id='span_animate_server_div'><img src='themes/Sugar/images/basic_search.gif' width='8' height='8' border='0'>&nbsp;Collapse</span></a></slot>";
        }else{
            $form2 .= "<slot><a class=\"listViewTdToolsS1\" id='href_animate' onClick=\"PackageManager.toggleDiv('span_animate_server_div', 'catview');\"><span id='span_animate_server_div' style='display:none;'><img src='themes/Sugar/images/basic_search.gif' width='8' height='8' border='0'>&nbsp;Collapse</span></a></slot>";
        }
        $form2 .= "</td></tr></table>";
   ...
   $str = $ss->fetch('ModuleInstall/PackageManager/tpls/PackageForm.tpl');
    ...
    function buildPatchDisplay($form1, $hidden_fields, $form_action, $types = array('module'), $active_form = 'form1'){
        ...
        $form2 .= "</td><td align='right'><div id='workingStatusDiv' style='display:none;'>".get_image($image_path."sqsWait","border='0' align='bottom'")."</div></td></tr><tr><td colspan='2'>";
