<?php /* Smarty version 2.6.11, created on 2009-06-23 11:01:22
         compiled from modules/Studio/TabGroups/EditViewTabs.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'modules/Studio/TabGroups/EditViewTabs.tpl', 110, false),array('function', 'sugar_translate', 'modules/Studio/TabGroups/EditViewTabs.tpl', 131, false),)), $this); ?>
...
<li class='nobullet' id='trashcan'><?php echo $this->_tpl_vars['deleteImage'];  echo $this->_tpl_vars['MOD']['LBL_DELETE_MODULE']; ?>
</li>
...
<?php echo '
		  ...
		  function addTabGroup(){
		  	...
		  	headerSpan.innerHTML = \'';  echo $this->_tpl_vars['MOD']['LBL_NEW_GROUP'];  echo '\';
		  	...
		  	editLabel.type = \'text\';
		  	editLabel.value = \'';  echo $this->_tpl_vars['MOD']['LBL_NEW_GROUP'];  echo '\';
		  	...
		  	li.innerHTML = \'';  echo $this->_tpl_vars['MOD']['LBL_DROP_HERE'];  echo '\';
		  	list.appendChild(li);
