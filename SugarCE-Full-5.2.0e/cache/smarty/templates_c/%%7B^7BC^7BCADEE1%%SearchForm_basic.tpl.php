<?php /* Smarty version 2.6.11, created on 2009-06-30 18:19:25
         compiled from cache/modules/HRM_Employees/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/HRM_Employees/SearchForm_basic.tpl', 11, false),array('function', 'math', 'cache/modules/HRM_Employees/SearchForm_basic.tpl', 12, false),array('function', 'sugar_translate', 'cache/modules/HRM_Employees/SearchForm_basic.tpl', 22, false),)), $this); ?>
...
' title='' tabindex='' > 
	...
	<td class="dataLabel" nowrap="nowrap" width='10%' >
		...
		<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SAL_PRES','module' => 'HRM_Employees'), $this);?>
...
<?php if (strval ( $this->_tpl_vars['fields']['sal_pres_basic']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED');  elseif (strval ( $this->_tpl_vars['fields']['sal_pres_basic']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED');  else: ?>
	<?php $this->assign('default', 'SELECTED');  endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['sal_pres_basic']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['sal_pres_basic']['name']; ?>
" tabindex="" >
