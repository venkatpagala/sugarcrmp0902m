...
{if strval($fields.sal_pres_basic.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.sal_pres_basic.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.sal_pres_basic.name}" name="{$fields.sal_pres_basic.name}" tabindex="" >
