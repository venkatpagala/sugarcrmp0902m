...
<input type="button" onclick="document.AdminSettings.process.value='true'; if(check_form('AdminSettings')) {ldelim} document.AdminSettings.submit(); {rdelim}" class="button" title="{$app.LBL_SAVE_BUTTON_TITLE}" accessKey="{$app.LBL_SAVE_BUTTON_KEY}" value="{$app.LBL_SAVE_BUTTON_LABEL}">
...
<tr>
<td class="dataLabel" align="right" nowrap>{$mod.LBL_ENABLE_FEED}:</td>
<td class="dataField" align="left" width="25%">
...
<tr>
<td class="dataLabel" align="right" valign="top" nowrap>{$mod.LBL_ENABLE_MODULE_LIST}:</td>
...
{if ($i % 2)==0}<tr>{/if}
<td class="dataLabel" align="right">{$entry.label}:</td>
<td class="dataField">
...
<tr>
<td class="dataLabel" align="right" nowrap>{$mod.LBL_ENABLE_USER_FEED}:</td>
<td class="dataField" align="left" width="25%">
