...
<table class='mbTable' >
	...
	<tr>	
		<td></td><td id='readme'><img id="options" border="0"  alt="Hide Options" src="themes/Sugar/images/advanced_search.gif"><a style="text-decoration:none" href="javascript: void(0)" onclick ="toggleEl('readmefield');"><b>{$mod_strings.LBL_ADD_README}</b></a></td>
	</tr>
	<tr>
		<td height='100%'>&nbsp;</td><td>&nbsp;</td>
	</tr>
