...
if(!empty($_REQUEST['assigned_user_id'])){
 ...
 $Web_To_Lead_Form_html ='<link rel="stylesheet" type="text/css" media="all" href="' . getJSPath('themes/' . $GLOBALS['theme'] . '/calendar-win2k-cold-1.css') . '">';
...
<img src=\"themes/default/images/jscalendar.gif\" alt=\"{$LBL_ENTER_DATE}\" id=\"{$field_name}_trigger\" align=\"absmiddle\">
<script type='text/javascript'>
Calendar.setup ({
    inputField : \"{$field_name}\", ifFormat : \"{$cal_dateformat}\", showsTime : false, button : \"{$field_name}_trigger\", singleClick : true, step : 1
});
...
<img src=\"themes/default/images/jscalendar.gif\" alt=\"{$LBL_ENTER_DATE}\" id=\"{$field1_name}_trigger\" align=\"absmiddle\">
<script type='text/javascript'>
Calendar.setup ({
    inputField : \"{$field1_name}\", ifFormat : \"{$cal_dateformat}\", showsTime : false, button : \"{$field1_name}_trigger\", singleClick : true, step : 1
});
</script></span sugar='slot'></td>";         
          //$Web_To_Lead_Form_html .= "<td width='35%' style='font-size: 12px; font-weight: normal;'><span sugar='slot'><input type='checkbox' id=$field_name name=$field_name></span sugar='slot'></td>";
         } // if         
