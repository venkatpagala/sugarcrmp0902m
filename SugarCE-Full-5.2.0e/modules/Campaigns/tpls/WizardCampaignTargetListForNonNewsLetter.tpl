...
*}
	...
	<tr>
	<th colspan="5" align="left" class="dataField"><h4 class="dataLabel">{$MOD.LBL_TARGET_LISTS}</h4></th>
	</tr>
	<tr>
	<td class="dataLabel" colspan="5">{$MOD.LBL_WIZARD_TARGET_MESSAGE1}<br></td>
	</tr>
	<tr><td colspan=5>&nbsp;</td></tr>
	<tr>
	<td class="dataLabel" colspan="4">{$MOD.LBL_SELECT_TARGET}&nbsp;
	...
	<tr><td colspan=5>&nbsp;</td></tr>
	<tr>
	<td class="dataLabel" colspan="5">{$MOD.LBL_WIZARD_TARGET_MESSAGE2}<br></td>
	</tr>
	<tr>
	<td width='10%' class="dataLabel">{$MOD.LBL_TARGET_NAME}</td>
