...
*}
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		<th colspan="4" align="left" class="dataField"><h4 class="dataLabel">{$MOD.LBL_WIZ_NEWSLETTER_TITLE_STEP3}</h4></th>
		</tr>
	...
	<div id='tracker_input_div'>
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
		<tr>
		<td width="15%" class="dataLabel"><slot>{$MOD.LBL_EDIT_TRACKER_NAME}<span class="required">&nbsp;</span></slot></td>
		<td width="25%" class="dataField"><slot><input id="tracker_name" type="text" size="30" tabindex='1' name="tracker_name" title="{$MOD.LBL_EDIT_TRACKER_NAME}" value="{$TRACKER_NAME}"></slot></td>
		<td width="25%" class="dataLabel"><slot><input onclick="toggle_tracker_url(this);" name="is_optout" title="{$MOD.LBL_EDIT_OPT_OUT}" id="is_optout" tabindex='2' class="checkbox" type="checkbox" />&nbsp;{$MOD.LBL_EDIT_OPT_OUT_}</slot></td>
	    <td width="35%" class="dataField"><slot>&nbsp;</slot></td>	
		</tr>
		<tr>
		<td class="dataLabel"><slot>{$MOD.LBL_EDIT_TRACKER_URL}&nbsp;<span class="required"></span></slot></td>
		<td class="dataField" colspan=3><slot><input type="text" size="80" maxlength='255' tabindex='3' {$TRACKER_URL_DISABLED} name="tracker_url" title="{$MOD.LBL_EDIT_TRACKER_URL}" id="tracker_url" value="http://"></slot> <input type='button' value ='{$MOD.LBL_ADD_TRACKER}' class= 'button' onclick='javascript:add_tracker();'></td>
		</tr>
	...
	<table width='100%' border="0" cellspacing="0" cellpadding="0">
		...
		<tr><td class='listView'>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr >
			    <td width='15%' class="listViewThS1" nowrap>{$MOD.LBL_EDIT_OPT_OUT}</td>
				<td width='40%' class="listViewThS1">{$MOD.LBL_EDIT_TRACKER_NAME}</td>
			    <td width='45%' class="listViewThS1" colspan="2">{$MOD.LBL_EDIT_TRACKER_URL}</td>
		    </tr>
			</table>
	...
	<p>
		...
		{literal}
			...
			{/literal}			
					...
					//display the html
					//var trkr_html = "<div id='trkr_added_"+trackers_added+"'> "+trkr_opt_html+"  "+trkr_name_html+"  "+trkr_url_html+" <a href='#' onclick=\"javascript:remove_tracker('trkr_added_"+trackers_added+"','"+trackers_added+"'); \" >  <img src='{$IMAGE_PATH}delete_inline.gif' alt='rem' align='absmiddle' border='0' height='12' width='12'>{$MOD.LBL_REMOVE}</a><br></div>";						
					var trkr_html = "<div id='trkr_added_"+trackers_added+"'> <table width='100%' border='0' cellspacing='0' cellpadding='0'><tr><td width='15%' class='evenListRowS1'>"+trkr_opt_html+"</td><td width='40%' class='evenListRowS1'>"+trkr_name_html+"</td><td width='40%' class='evenListRowS1'>"+trkr_url_html+"</td><td class='evenListRowS1'><a href='#' onclick=\"javascript:remove_tracker('trkr_added_"+trackers_added+"','"+trackers_added+"'); \" >  <img src='{$IMAGE_PATH}delete_inline.gif' alt='rem' align='absmiddle' border='0' height='12' width='12'>{$MOD.LBL_REMOVE}</a></td></tr></table></div>";						
