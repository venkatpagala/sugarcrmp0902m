...
function multiFiles( list_target){
	...
	imgElement.setAttribute("src", "themes/default/images/Accounts.gif");
	...
	new_row_button_embed.setAttribute("src", "themes/default/images/attachment.gif");
...
function docUpload() {
    ...
    eai.onclick=function(){
    	var filename = this.parentNode.childNodes[4].value;
	    	if(filename != null){
                var tiny = tinyMCE.getInstanceById('body_text');
				var currValTiny = tinyMCE.getContent('body_text');
   ...
   SugarDoc.setAttribute("src", "themes/default/images/sugar_document.png");
...
function toggle_textonly() {
	...
	if(html.style.display == 'none') {
		...
		if(tiny.getHTML()) {
			var htmlText = new String(tiny.getHTML());
...
function appendEmailTemplateJSON() {
	...
	var tiny = tinyMCE.getInstanceById("description_html");
	var tinyHtml = tiny.getHTML(true);
	...
	if(document.getElementById('setEditor').checked == true) {
		...
		tiny.setHTML(tinyHtml + descHtml);
	}
...
function quick_create_overlib(id, theme) {
    return overlib('<a style=\'width: 150px\' class=\'menuItem\' onmouseover=\'hiliteItem(this,"yes");\' onmouseout=\'unhiliteItem(this);\' href=\'index.php?module=Cases&action=EditView&inbound_email_id=' + id + '\'>' +
            "<img border='0' src='themes/default/images/Cases.gif' style='margin-right:5px'>" + SUGAR.language.get('Emails', 'LBL_LIST_CASE') + '</a>' +
            "<a style='width: 150px' class='menuItem' onmouseover='hiliteItem(this,\"yes\");' onmouseout='unhiliteItem(this);' href='index.php?module=Leads&action=EditView&inbound_email_id=" + id + "'>" +
                    "<img border='0' src='themes/default/images/Leads.gif' style='margin-right:5px'>"
             ...
             "<a style='width: 150px' class='menuItem' onmouseover='hiliteItem(this,\"yes\");' onmouseout='unhiliteItem(this);' href='index.php?module=Bugs&action=EditView&inbound_email_id=" + id + "'>"+
                    "<img border='0' src='themes/default/images/Bugs.gif' style='margin-right:5px'>"
             ...
             "<a style='width: 150px' class='menuItem' onmouseover='hiliteItem(this,\"yes\");' onmouseout='unhiliteItem(this);' href='index.php?module=Tasks&action=EditView&inbound_email_id=" + id + "'>" +
                    "<img border='0' src='themes/default/images/Tasks.gif' style='margin-right:5px'>"
                   + SUGAR.language.get('Emails', 'LBL_LIST_TASK') + "</a>"
            , CAPTION, SUGAR.language.get('Emails', 'LBL_QUICK_CREATE')
            , STICKY, MOUSEOFF, 3000, CLOSETEXT, '<img border=0  style="margin-left:2px; margin-right: 2px;" src="themes/' + theme + '/images/close.gif">', WIDTH, 150, CLOSETITLE, SUGAR.language.get('app_strings', 'LBL_ADDITIONAL_DETAILS_CLOSE_TITLE'), CLOSECLICK, FGCLASS, 'olOptionsFgClass',
