...
<script type="text/javascript" src='include/javascript/sugar_grp_ytree.js?s={$sugarVersion}&c={$jsCustomVersion}'></script>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" class="subpanelTabForm" style="border-top: 0px none; margin-bottom: 4px;">
 	<tr>
		...
		<td rowspan="3">
				<img src='include/images/blank.gif' width='15' height='1' border='0'>
		</td>
		{/if}
		{if $numCols > 1}
		<td>
