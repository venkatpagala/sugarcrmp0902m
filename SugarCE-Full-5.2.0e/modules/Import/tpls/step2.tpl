...
<tr>
	<td align="left" class="body"><p>{$INSTRUCTIONS_TITLE}</p></td>
</tr>
<tr>
	<td>
	<table width="50%">
{/if}
	<tr>
		<td valign="top" class="body"><b>{$item.STEP_NUM}</b></td>
		<td class="body">{$item.INSTRUCTION_STEP}</td>
	</tr>
...
<td>
	...
	<tr>
	<th align="left" class="dataLabel" colspan="4">{$MOD.LBL_SELECT_FILE}</th>
	</tr>
	<tr>
	<td class="dataLabel">
	<input type="hidden" />
