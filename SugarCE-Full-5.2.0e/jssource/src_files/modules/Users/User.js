...
SUGAR.user = {
	/**
	 * Prefills SMTP form with defaults for Gmail SMTP over SSL
	 */
	fillGmailDefaults : function() {
		...
		notify_setrequired(document.getElementById("EditView"));
	},

	showHideGmailDefaultLink : function(el) {
		var link = document.getElementById("gmailDefaults");
		if(el.options[el.selectedIndex].value == 'SMTP') {
