<?php /* Smarty version 2.6.11, created on 2009-06-08 21:28:57
         compiled from cache/modules/Calls/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/modules/Calls/EditView.tpl', 38, false),array('function', 'counter', 'cache/modules/Calls/EditView.tpl', 43, false),array('function', 'sugar_translate', 'cache/modules/Calls/EditView.tpl', 48, false),array('function', 'html_options', 'cache/modules/Calls/EditView.tpl', 74, false),array('modifier', 'default', 'cache/modules/Calls/EditView.tpl', 44, false),array('modifier', 'strip_semicolon', 'cache/modules/Calls/EditView.tpl', 50, false),)), $this); ?>
...
<input tabindex="0"  name="duration_hours" tabindex="1" size="2" maxlength="2" type="text" value="<?php echo $this->_tpl_vars['fields']['duration_hours']['value']; ?>
...
<script type="text/javascript" src="include/JSON.js?s=b4fa423902ec31447936886be8ed48d7&c=1"></script>
<script type="text/javascript" src="include/jsolait/init.js?s=b4fa423902ec31447936886be8ed48d7&c=1"></script>
<script type="text/javascript" src="include/jsolait/lib/urllib.js?s=b4fa423902ec31447936886be8ed48d7&c=1"></script>
<script type="text/javascript"><?php echo $this->_tpl_vars['JSON_CONFIG_JAVASCRIPT']; ?>
</script>
<script type="text/javascript" src="include/javascript/jsclass_base.js?s=b4fa423902ec31447936886be8ed48d7&c=1"></script>
<script type="text/javascript" src="include/javascript/jsclass_async.js?s=b4fa423902ec31447936886be8ed48d7&c=1"></script>
<script type="text/javascript" src="modules/Meetings/jsclass_scheduler.js?s=b4fa423902ec31447936886be8ed48d7&c=1"></script>
...
addToValidate(\'EditView\', \'parent_type\', \'varchar\', false,\'';  echo smarty_function_sugar_translate(array('label' => 'LBL_PARENT_TYPE','module' => 'Calls'), $this); echo '\' );
