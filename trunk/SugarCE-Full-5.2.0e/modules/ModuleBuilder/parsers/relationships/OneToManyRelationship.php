...
class OneToManyRelationship extends AbstractRelationship
{
    ...
    {        
        ...
        return array( $this->lhs_module => $this->getSubpanelDefinition ( $this->relationship_name, $this->rhs_module, $this->rhs_subpanel ) ) ;
    }
    ...
    function buildVardefs ( )
    {
        ...
        if (! $this->relationship_only)
        {
            $vardefs [ $this->rhs_module ] [] = $this->getRelateFieldDefinition ( $this->lhs_module, $this->relationship_name ) ;
