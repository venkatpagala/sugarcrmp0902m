...
class DeployedRelationships extends AbstractRelationships implements RelationshipsInterface
{
    ...
    /*
     * This function is here as a catch-all - should never be called for DeployedRelationships as they are implemented (built) as part of the save and then they become read-only
     */
    function delete ()
    {
        // nothing to do for DeployedRelationships
    }
