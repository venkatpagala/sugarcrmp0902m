 ...
 * "Powered by SugarCRM".
 */
function ygDDSlot(id,sGroup){if(id){this.init(id,sGroup);this.initFrame();this.logger=new ygLogger("ygDDSlot");}
...
ygDDSlot.prototype.onDragDrop=function(e,id){this.logger.debug(this.id+" onDragDrop");var cur=this.getEl();var curb;if("string"==typeof id){curb=YAHOO.util.DDM.getElement(cur.id+"b");}else{curb=YAHOO.util.DDM.getBestMatch(cur.id+"b").getEl();}
