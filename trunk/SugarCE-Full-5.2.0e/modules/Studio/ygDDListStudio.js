...
this.initFrame();this.logger=new ygLogger("ygDDList");this.fromOnly=fromOnly;}
...
function ygDDListStudioBoundary(id,sGroup){if(id){this.init(id,sGroup);this.logger=new ygLogger("ygDDListStudioBoundary");this.isBoundary=true;}}
