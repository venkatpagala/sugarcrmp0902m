...
function setTinyHTML(text){var tiny=tinyMCE.getInstanceById('body_text');if(tiny.getHTML()!=null){tiny.setHTML(text)}else{setTimeout(setTinyHTML(text),1000);}}
...
function insert_variable_html_link(text){var thelink="<a href='"+text+"' > "+label+" </a>";insert_variable_html(thelink);}
