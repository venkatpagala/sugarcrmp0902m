...
<table cellpadding="4" cellspacing="0" border="0">
	...
	<tr>
		<td NOWRAP>
			...
			<img src="themes/default/images/jscalendar.gif" alt="{$app_strings.LBL_ENTER_DATE}" id="jscal_trigger_from" align="absmiddle">
		</td>
	</tr>
	...
	<tr>
		<td NOWRAP>
			...
			<img src="themes/default/images/jscalendar.gif" alt="{$app_strings.LBL_ENTER_DATE}" id="jscal_trigger_to" align="absmiddle">
		</td>
	</tr>
	<tr>
		<td NOWRAP>
