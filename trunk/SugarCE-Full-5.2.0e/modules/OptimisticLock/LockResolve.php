...
function display_conflict_between_objects($object_1, $object_2, $field_defs,$module_dir, $display_name){
	...
	$object1_row= '<tr class="oddListRowS1" bgcolor="'.$odd_bg.'"><td><b>'. $mod_strings['LBL_YOURS'] . '</b></td>';
	$object2_row= '<tr class="evenListRowS1" bgcolor="'.$even_bg.'"><td><b>' . $mod_strings['LBL_IN_DATABASE'] . '</b></td>';
	$exists = false;
