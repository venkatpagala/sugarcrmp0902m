<?php /* Smarty version 2.6.11, created on 2009-06-25 15:53:07
         compiled from modules/Studio/ListViewEditor/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'modules/Studio/ListViewEditor/EditView.tpl', 113, false),array('function', 'sugar_translate', 'modules/Studio/ListViewEditor/EditView.tpl', 126, false),)), $this); ?>
...
'>
<span class='slotB'><?php if (! empty ( $this->_tpl_vars['translate'] )):  echo smarty_function_sugar_translate(array('label' => $this->_tpl_vars['value']['label'],'module' => $this->_tpl_vars['module']), $this); else:  echo $this->_tpl_vars['value']['label'];  endif; ?></span>
<?php if (empty ( $this->_tpl_vars['hideKeys'] )): ?> <br><span class='fieldValue'>[<?php echo $this->_tpl_vars['key']; ?>
]<?php endif; ?></span>
</li>
<script>
