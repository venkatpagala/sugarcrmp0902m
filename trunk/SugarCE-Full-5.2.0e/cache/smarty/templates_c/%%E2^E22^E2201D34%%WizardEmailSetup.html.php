<?php /* Smarty version 2.6.11, created on 2009-06-23 15:44:08
...
<tr><td class='tabDetailViewDL2' nowrap><div id='nav_step1'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_SETUP']; ?>
</div></td></tr>
<tr><td class='tabDetailViewDL2' nowrap><div id='nav_step2'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_NEW_MAILBOX']; ?>
</div></td></tr>
<tr><td class='tabDetailViewDL2' nowrap><div id='nav_step3'><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_SUMMARY']; ?>
</div></td></tr>
</table>
</div>
</td>
...
<div id=wizard>
	...
	<tr>
	<th colspan="2" align="left" class="dataField"><h4 class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_NAVIGATION_MENU_SETUP']; ?>
</h4></th>
	</tr>
	<tr>
				...
				<tr>
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td width="20%" class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_WIZ_FROM_NAME']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></td>
								<td width="30%" class="dataField"><input name="wiz_step1_notify_fromname" tabindex='1' size='25' maxlength='128' type="text" id="notify_fromname" value="<?php echo $this->_tpl_vars['notify_fromname']; ?>
" title="<?php echo $this->_tpl_vars['MOD']['LBL_WIZ_FROM_NAME']; ?>
"></td>
							</tr>
							<tr>
								<td class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SENDTYPE']; ?>
</td>
								<td class="dataField">
...
" onChange="notify_setrequired();" tabindex="1"><?php echo $this->_tpl_vars['mail_sendtype_options']; ?>
								...
								<td class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_WIZ_FROM_ADDRESS']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></td>
								<td class="dataField"><input name='wiz_step1_notify_fromaddress' id='notify_fromaddress' tabindex='1' size='25' maxlength='128' type="text" value="<?php echo $this->_tpl_vars['notify_fromaddress']; ?>
								...
								<td colspan="4">
									<div id="smtp_settings">
										<table width="100%" cellpadding="0" cellspacing="0">
											<tr>
												<td width="20%" class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SMTPSERVER']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></td>
												<td width="30%" class="dataField"><input type="text"  title="<?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SMTPSERVER']; ?>
...
"></td>
												<td width="20%" class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SMTPPORT']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></td>
												<td width="30%" class="dataField"><input type="text" id='mail_smtpport' name="wiz_step1_mail_smtpport" title="<?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SMTPPORT']; ?>
...
>
												...
												<td width="15%" class="dataLabel">&nbsp;&nbsp;<?php echo $this->_tpl_vars['MOD']['LBL_SSL']; ?>
:</td>
                                                <td width="35%" class="dataField">
                                                    <input type="checkbox" id="mail_smtpssl" title="<?php echo $this->_tpl_vars['MOD']['LBL_SSL']; ?>
" name="mail_smtpssl" tabindex="1" value="1" <?php echo $this->_tpl_vars['MAIL_SMTPSSL']; ?>
>
                                                </td>
											</tr>
											<tr>
												<td colspan="4">
													<div id="smtp_auth">
														<table width="100%" cellpadding="0" cellspacing="0">
															<tr>
																<td width="20%" class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SMTPUSER']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></td>
																<td width="30%" class="dataField"><input type="text" name="wiz_step1_mail_smtpuser" id='mail_smtpuser' title='<?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SMTPUSER']; ?>
' size="25" maxlength="64" value="<?php echo $this->_tpl_vars['mail_smtpuser']; ?>
" tabindex='1' ></td>
																<td width="20%" class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SMTPPASS']; ?>
 <span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></td>
																<td width="30%" class="dataField"><input type="password" title="<?php echo $this->_tpl_vars['MOD']['LBL_MAIL_SMTPPASS']; ?>
...
" tabindex='1'></td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr><td>&nbsp;</td></tr>
				<tr><td>&nbsp;</td></tr>
				<tr><td><h4 class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_NOTIFY_TITLE']; ?>
</h4></td></tr>
			<tr><td>
			 <table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
				<td width="40%" class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_EMAILS_PER_RUN']; ?>
&nbsp;<span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></td>
				<td width="50%" class="dataField"><input name='wiz_step1_massemailer_campaign_emails_per_run' id='massemailer_campaign_emails_per_run' title="<?php echo $this->_tpl_vars['MOD']['LBL_EMAILS_PER_RUN']; ?>
"tabindex='1' maxlength='128' type="text" value="<?php echo $this->_tpl_vars['EMAILS_PER_RUN']; ?>
"></td>
				</tr><tr>
				<td class="dataLabel"><?php echo $this->_tpl_vars['MOD']['LBL_LOCATION_TRACK']; ?>
&nbsp;<span class="required"><?php echo $this->_tpl_vars['APP']['LBL_REQUIRED_SYMBOL']; ?>
</span></td>
				<td class="dataField"><input type='radio' onclick="change_state(this);" name='wiz_massemailer_tracking_entities_location_type' id='massemailer_tracking_entities_location_type' title="<?php echo $this->_tpl_vars['MOD']['LBL_DEFAULT_LOCATION']; ?>
...
" value="2"><?php echo $this->_tpl_vars['MOD']['LBL_CUSTOM_LOCATION']; ?>
				...
				<td class="dataField"><input name='wiz_step1_massemailer_tracking_entities_location'  id='massemailer_tracking_entities_location' title="<?php echo $this->_tpl_vars['MOD']['LBL_LOCATION_TRACK']; ?>
...
</span><img border="0" src="themes/default/images/help.gif"></a>
                    </div>
...
';
	...
	<tr>
	<td class="dataLabel" colspan ='3'><?php echo $this->_tpl_vars['MAILBOXES_DETECTED_MESSAGE']; ?>
</td></td>&nbsp;</td>
	</tr>	
...
:&nbsp;</slot></td>
			<td valign="top" class="dataField" width="30%" NOWRAP>
