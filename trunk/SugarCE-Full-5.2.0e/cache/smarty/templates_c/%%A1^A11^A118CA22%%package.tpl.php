<?php /* Smarty version 2.6.11, created on 2009-07-02 10:22:38
         compiled from modules/ModuleBuilder/tpls/MBPackage/package.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'modules/ModuleBuilder/tpls/MBPackage/package.tpl', 102, false),array('function', 'sugar_image', 'modules/ModuleBuilder/tpls/MBPackage/package.tpl', 106, false),)), $this); ?>
...
' class='button' onclick="ModuleBuilder.packageDeploy('CreatePackage');">
...
>
	...
	<tr>	
		<td></td><td id='readme'><img id="options" border="0"  alt="Hide Options" src="themes/Sugar/images/advanced_search.gif"><a style="text-decoration:none" href="javascript: void(0)" onclick ="toggleEl('readmefield');"><b><?php echo $this->_tpl_vars['mod_strings']['LBL_ADD_README']; ?>
</b></a></td>
	</tr>
	<tr>
		<td height='100%'>&nbsp;</td><td>&nbsp;</td>
...
function toggleEl(){
		...
		if(display==\'table-row\' || display==\'inline-block\'){
			document.getElementById(\'options\').src = "themes/Sugar/images/advanced_search.gif";
			document.getElementById(\'readmefield\').style.display =\'none\';
		}else if (display==\'none\'){
			document.getElementById(\'options\').src = "themes/Sugar/images/basic_search.gif";
