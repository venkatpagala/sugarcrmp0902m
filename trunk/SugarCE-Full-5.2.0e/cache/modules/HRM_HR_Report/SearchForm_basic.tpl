...
{html_options name='rep_mois_basic[]' options=$fields.rep_mois_basic.options size="6" style='width:150' multiple="1" selected=$fields.rep_mois_basic.value}
...
{if strlen($fields.rep_year_basic.value) <= 0}
{assign var="value" value=$fields.rep_year_basic.default_value }
{else}
{assign var="value" value=$fields.rep_year_basic.value }
{/if}  
<input type='text' name='{$fields.rep_year_basic.name}' id='{$fields.rep_year_basic.name}' size='30' maxlength='11' value='{$value}' title='' tabindex='' > 
