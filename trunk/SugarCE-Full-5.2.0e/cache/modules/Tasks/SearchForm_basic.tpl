...
{/if}  
<input type='text' name='{$fields.contact_name_basic.name}' id='{$fields.contact_name_basic.name}' size='30' maxlength='510' value='{$value}' title='' tabindex='' > 
