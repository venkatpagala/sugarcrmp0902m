...
$the_header = "";
       	$the_header .='<h3 class="leftColumnModuleName">'.$left_title.'</h3>';
...
if($is_min_max === false) {
	$the_form .= '<td nowrap><h3 id="blue"><span id="h3bg">'.$form_title.'</span></h3></td>';
} else {
	$the_form .= "<td nowrap><h3 id='blue'><span id='h3bg'>{$other_text}&nbsp;{$form_title}</span></h3></td>";
}
...
$the_form .= "<td colspan='10' width='100%'><IMG height='1' width='1' src='$blank' alt=''></td>\n";
	$the_form .= "</tr><tr>\n";
	$the_form .= "<td align='left' valign='middle' nowrap class='utils'>$other_text</td>\n";
...
class='utilsLink'>".$app_strings['LNK_HELP']."</A></td>\n";
	...
	if ($show_help==true) {
		$the_form .= "<td align='right' nowrap class='utils'>";
		if ($_REQUEST['action'] != "EditView") {
	     	$the_form .= "<A
href='index.php?".$GLOBALS['request_string']."' class='utilsLink'><img
src='".$image_path."print.gif' width='13' height='13' alt='Print' border='0'
...
$the_title = "<table width='100%' cellpadding='0' cellspacing='0' border='0' class='moduleTitle'><tr><td valign='bottom'><h2><span id='h2bg'>\n";
$module = preg_replace("/ /","",$module);
if (is_file($image_path.$module.".gif")) {
	$the_title .= "<IMG src='".$image_path.$module.".gif' width='16' height='16' border='0' style='padding-bottom: 2px; padding-right: 3px;' alt='".$module."' align='absmiddle'>";
}
$the_title .= "".$module_title."</span></h2></td>\n";

if ($show_help) {

		$the_title .= "<td valign='top' align='right' nowrap  class='utils'>";
