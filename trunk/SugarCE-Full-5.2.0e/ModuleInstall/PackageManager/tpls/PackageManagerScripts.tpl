...
PackageManagerGrid = function(){
	...
	{/literal}{if $module_load == 'true'}{literal}
		_fileGrid = new YAHOO.ext.grid.DDGrid(
                ...
                new YAHOO.ext.grid.DefaultColumnModel([
					{header: '{/literal}{$ML_FILEGRID_COLUMN.Name}{literal}', width: 200, sortable: true, sortType: sort.asUCString},
                    {header: '{/literal}{$ML_FILEGRID_COLUMN.Install}{literal}', width: 60, renderer: this.renderInstallButton},
                    {header: '{/literal}{$ML_FILEGRID_COLUMN.Delete}{literal}', width: 120, renderer: this.renderDeleteButton},
        		    {header: '{/literal}{$ML_FILEGRID_COLUMN.Type}{literal}', width: 60},
        		    {header: '{/literal}{$ML_FILEGRID_COLUMN.Version}{literal}', width: 50},
        		    {header: '{/literal}{$ML_FILEGRID_COLUMN.Published}{literal}', width: 75},
        		    {header: '{/literal}{$ML_FILEGRID_COLUMN.Uninstallable}{literal}', width: 70},
        		    {header: '{/literal}{$ML_FILEGRID_COLUMN.Description}{literal}', width: 370, sortable: true, sortType: sort.asUCString}
            ...
            _fileGrid.autoSizeColumns = true;
	           ...
	           _fileGridInstalled = new YAHOO.ext.grid.DDGrid(
                ...
                new YAHOO.ext.grid.DefaultDataModel(mti_installed_data),
                 new YAHOO.ext.grid.DefaultColumnModel([
					{header: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Name}{literal}', width: 200, sortable: true, sortType: sort.asUCString},
                    {header: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Install}{literal}', width: 5, hidden:true},
                    {header: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Action}{literal}', width: 80, renderer: this.renderUninstallButton},
                    {header: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Enable_Or_Disable}{literal}', width: 80, renderer: this.renderEnableDisableButton},
        		    {header: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Type}{literal}', width: 60},
        		    {header: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Version}{literal}', width: 50},
        		    {header: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Date_Installed}{literal}', width: 105},
        		    {header: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Uninstallable}{literal}', width: 5, hidden:true},
        		    {header: '{/literal}{$ML_FILEGRIDINSTALLED_COLUMN.Description}{literal}', width: 475, sortable: true, sortType: sort.asUCString}
        		])
            );
	...
	{/literal}{else}{literal}
  		_fileGrid = new YAHOO.ext.grid.DDGrid(
                ...
                new YAHOO.ext.grid.DefaultColumnModel([
					{header: '{/literal}{$ML_FILEGRID_COLUMN.Description}{literal}', width: 215},
        		    {header: '{/literal}{$ML_FILEGRID_COLUMN.Version}{literal}', width: 72},
        		    {header: '{/literal}{$ML_FILEGRID_COLUMN.Build}{literal}', width: 80, sortable: true, sortType: sort.asUCString},
        		    {header: '{/literal}{$ML_FILEGRID_COLUMN.Action}{literal}', width: 90, renderer: this.renderButtons}
        		])
            );
            _fileGrid.autoSizeColumns = true;
