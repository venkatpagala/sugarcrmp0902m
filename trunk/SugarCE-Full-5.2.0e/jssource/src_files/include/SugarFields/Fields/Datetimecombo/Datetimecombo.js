 ...
 * @param tabindex
 */
function Datetimecombo (datetime, field, timeformat, tabindex, showCheckbox, checked) {
...
Datetimecombo.prototype.html = function(callback) {
	...
	var text = '<select size="1" id="' + this.fieldname + '_hours" tabindex="' + this.tabindex + '" onchange="combo_' + this.fieldname + '.update(); ' + callback + '">';
	...
	text += '\n&nbsp;<select size="1" id="' + this.fieldname + '_minutes" tabindex="' + this.tabindex + '" onchange="combo_' + this.fieldname + '.update(); ' + callback + '">';
	...
	if(this.hasMeridiem) {
		text += '\n&nbsp;';
		text += '\n<select size="1" id="' + this.fieldname + '_meridiem" tabindex="' + this.tabindex + '" onchange="combo_' + this.fieldname + '.update(); ' + callback + '">';
