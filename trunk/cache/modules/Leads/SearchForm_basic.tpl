...
{html_options name='lead_source_basic[]' options=$fields.lead_source_basic.options size="6" style='width:150' multiple="1" selected=$fields.lead_source_basic.value}
