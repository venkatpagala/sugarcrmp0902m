...
{/if}  
<input type='text' name='{$fields.name_advanced.name}' id='{$fields.name_advanced.name}' size='30' maxlength='150' value='{$value}' title='' tabindex='' > 
   	   	</td>
...
{/if}  
<input type='text' name='{$fields.billing_address_city_advanced.name}' id='{$fields.billing_address_city_advanced.name}' size='30' maxlength='100' value='{$value}' title='' tabindex='' > 
   	   	</td>
...
{/if}  
<input type='text' name='{$fields.billing_address_state_advanced.name}' id='{$fields.billing_address_state_advanced.name}' size='30' maxlength='100' value='{$value}' title='' tabindex='' > 
   	   	</td>
...
{/if}  
<input type='text' name='{$fields.billing_address_country_advanced.name}' id='{$fields.billing_address_country_advanced.name}' size='30'  value='{$value}' title='' tabindex='' > 
   	   	</td>
