...
<select name="{$fields.direction.name}" id="{$fields.direction.name}" title='' tabindex="1"  >
...
addToValidate('EditView', 'parent_type', 'varchar', false,'{/literal}{sugar_translate label='LBL_PARENT_TYPE' module='Calls'}{literal}' );
