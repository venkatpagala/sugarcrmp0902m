...
class MssqlManager extends DBManager
{
     ...
     * @return resource
     */
	public function requireSingleResult(
        $sql,
        $dieOnError = false,
        $msg = '',
        $encode = true
    ...
    {
        $GLOBALS['log']->info('call to MssqlManager::requireSingleResult() is deprecated');
        ...
        $GLOBALS['log']->error('Rows Returned:'. $this->getRowCount($result) .
            ' No row or more than 1 row returned for '. $sql);
        return '';
	}
