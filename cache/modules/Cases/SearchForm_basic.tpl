...
{if strlen($fields.case_number_basic.value) <= 0}
{assign var="value" value=$fields.case_number_basic.default_value }
{else}
{assign var="value" value=$fields.case_number_basic.value }
{/if}  
<input type='text' name='{$fields.case_number_basic.name}' id='{$fields.case_number_basic.name}' size='30' maxlength='255' value='{$value}' title='' tabindex='' > 
