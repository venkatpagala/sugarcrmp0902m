<?php /* Smarty version 2.6.11, created on 2009-05-22 03:16:12
         compiled from include/SugarFields/Fields/Address/en_us.EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'upper', 'include/SugarFields/Fields/Address/en_us.EditView.tpl', 38, false),array('modifier', 'cat', 'include/SugarFields/Fields/Address/en_us.EditView.tpl', 39, false),array('modifier', 'lower', 'include/SugarFields/Fields/Address/en_us.EditView.tpl', 48, false),array('modifier', 'in_array', 'include/SugarFields/Fields/Address/en_us.EditView.tpl', 48, false),array('modifier', 'default', 'include/SugarFields/Fields/Address/en_us.EditView.tpl', 54, false),)), $this); ?>
{*
/*********************************************************************************
...
<tr>
<td id="<?php echo $this->_tpl_vars['street']; ?>
_label" valign="top" width='<?php echo $this->_tpl_vars['def']['templateMeta']['widths'][($this->_foreach['colIteration']['iteration']-1)]['label']; ?>
%' class="dataLabel" >
{sugar_translate label='LBL_<?php echo $this->_tpl_vars['key']; ?>
_ADDRESS' module='<?php echo $this->_tpl_vars['module']; ?>
'}:
<?php if (((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['street'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['displayParams']['required']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['displayParams']['required']))): ?>
...
'}:
<?php if (((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['city'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['displayParams']['required']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['displayParams']['required']))): ?>
<span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span>
<?php endif; ?>
</td>
<td width='<?php echo $this->_tpl_vars['def']['templateMeta']['widths'][($this->_foreach['colIteration']['iteration']-1)]['field']; ?>
...
'}:
<?php if (((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['state'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['displayParams']['required']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['displayParams']['required']))): ?>
<span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span>
<?php endif; ?>
</td>
<td width='<?php echo $this->_tpl_vars['def']['templateMeta']['widths'][($this->_foreach['colIteration']['iteration']-1)]['field']; ?>
...
'}:
<?php if (((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['postalcode'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['displayParams']['required']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['displayParams']['required']))): ?>
<span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span>
<?php endif; ?>
</td>
<td width='<?php echo $this->_tpl_vars['def']['templateMeta']['widths'][($this->_foreach['colIteration']['iteration']-1)]['field']; ?>
...
'}:
<?php if (((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['country'])) ? $this->_run_mod_handler('lower', true, $_tmp) : smarty_modifier_lower($_tmp)))) ? $this->_run_mod_handler('in_array', true, $_tmp, $this->_tpl_vars['displayParams']['required']) : smarty_modifier_in_array($_tmp, $this->_tpl_vars['displayParams']['required']))): ?>
<span class="required">{$APP.LBL_REQUIRED_SYMBOL}</span>
<?php endif; ?>
</td>
<td width='<?php echo $this->_tpl_vars['def']['templateMeta']['widths'][($this->_foreach['colIteration']['iteration']-1)]['field']; ?>
