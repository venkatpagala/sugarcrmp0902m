<?php /* Smarty version 2.6.11, created on 2009-06-08 21:47:28
         compiled from cache/modules/Bugs/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Bugs/SearchForm_basic.tpl', 11, false),array('function', 'math', 'cache/modules/Bugs/SearchForm_basic.tpl', 12, false),array('function', 'sugar_translate', 'cache/modules/Bugs/SearchForm_basic.tpl', 21, false),)), $this); ?>
...
<?php if (strlen ( $this->_tpl_vars['fields']['bug_number_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['bug_number_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['bug_number_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['bug_number_basic']['name']; ?>
' id='<?php echo $this->_tpl_vars['fields']['bug_number_basic']['name']; ?>
...
</table><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'modified_by_name_basic\']={"method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_basic","assigned_user_id_basic"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Kh\\u00f4ng h\\u1ee3p"};sqs_objects[\'created_by_name_basic\']={"method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_basic","assigned_user_id_basic"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Kh\\u00f4ng h\\u1ee3p"};sqs_objects[\'assigned_user_name_basic\']={"method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_basic","assigned_user_id_basic"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"Kh\\u00f4ng h\\u1ee3p"};sqs_objects[\'release_name_basic\']={"method":"query","modules":["Releases"],"group":"or","field_list":["name","id"],"populate_list":["release_name_basic","found_in_release_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Kh\\u00f4ng h\\u1ee3p"};sqs_objects[\'fixed_in_release_name_basic\']={"method":"query","modules":["Releases"],"group":"or","field_list":["name","id"],"populate_list":["fixed_in_release_name_basic","fixed_in_release_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"Kh\\u00f4ng h\\u1ee3p"};</script>'; ?>